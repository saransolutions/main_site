        ...
        <ul class="b-top-nav__1level_wrap">
          ...
          <li class="b-top-nav__1level f-top-nav__1level f-primary-b">
            <a href="home.php?lang=en">
                <i class="fa fa-folder-open b-menu-1level-ico"></i>'.$language.'
                <span class="b-ico-dropdown">
                    <i class="fa fa-arrow-circle-down"></i>
                </span>
            </a>
            <div class="b-top-nav__dropdomn">
                <ul class="b-top-nav__2level_wrap">
                    ...
                    <li class="b-top-nav__2level f-top-nav__2level f-primary">
                        <a href="home.php?lang=ta" class="f-option-total-cart__numbers b-option-total-cart__numbers"><img src="img/flags/ta.png"></img> தமிழ்</a>
                    </li>
                </ul>
            </div>
          </li>
...
function second_section($profile)
{
    ...
    <div class="col-md-3 col-sm-4 b-tabs-vertical__nav">
        <ul>
            <li><a class="f-primary-l" href="#tabs-1"><i class="fa fa-suitcase"></i>' . val("common", "header", "title", $profile["page"]) . '</a></li>
